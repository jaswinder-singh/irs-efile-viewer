							...
							<td rowspan="2" style="width:40mm;padding-bottom:1mm;">
								...
								<div style="border:3px solid black;float:right;" class="styGenericDiv">
									...
									<span style="padding-left:1mm;width37mm;vertical-align:top;">See instructions.
										<input class="styCkbox" type="checkbox" alt="ReturnHeaderMayIRSDiscussReturnWithPrep" name="Checkbox" id="dummyidyes" style="width:2.5mm;margin-top: 0px; margin-bottom: 0px;" >
											<xsl:call-template name="PopulateReturnHeaderOfficer">
										...
										<input class="styCkbox" type="checkbox" alt="ReturnHeaderMayIRSDiscussReturnWithPrep" name="Checkbox" id="dummyidno" style="width:2.5mm;margin-top: 0px; margin-bottom: 0px;">
											<xsl:call-template name="PopulateReturnHeaderOfficer">
              ...
              <span style="width:5mm;"/>
                ...
                vote of any foreign or domestic corporation not included on <b> Form 851, </b> Affiliations Schedule? For rules of constructive ownership,
					...
					<div class="styTableContainer" id="OFCctn3">
						...
						<table class="styTable" cellspacing="0" style="font-size:7pt;border-width:0px;">
							...
							<tbody>
								...
								</xsl:if>								<!-- Build blank row 5 data for Schedule K line 5a table -->
							</tbody>
						</table>
					</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:167mm;height:4mm; ">
			        Are the corporation’s total receipts (page 1, line 1a, plus lines 4 through 10) for the tax year <b>and</b> its total assets at the end of the 
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:4mm;"/>
						<div class="styLNDesc" style="width:167mm;height:4mm; ">
                      If "Yes," the corporation isn't required to complete Schedules L, M&#8208;1, and M&#8208;2. Instead, enter the 
                      total amount of cash
							</div>
						<div class="styShadingCell" style="width:6mm;height:4mm;"/>
						<div class="styShadingCellRB" style="width:6mm;height:4mm;border-right-width:0px;"/>
						<div class="styLNDesc" style="width:175mm;height:4mm;padding-left:8mm;"> distributions and the book value of property distributions (other than cash) made during the tax year.
                      <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:2px;"/>        
							<span style="width:1px;">$</span>
							...
							<tbody>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:51mm;height:6mm;" colspan="2">
										...
										<div class="styIRS1120BBText" style="width:26mm;float:left;text-align:right;padding-top:3mm;">
											<xsl:call-template name="PopulateAmount">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:54mm;height:4.5mm;" colspan="2">
										<div class="styGenericDiv" style="width:21mm;padding-top:0.5mm;">Depreciation<span style="width:1mm;"/>$ </div>
