...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:param name="Form1120Data" select="$RtnDoc/IRS1120EliminationsOrAdj"/>
    <xsl:param name="Form1120ScheduleA" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleA"/>
    <xsl:param name="Form1120ScheduleC" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleC"/>
    <xsl:param name="Form1120ScheduleE" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleE"/>
    <xsl:param name="Form1120ScheduleJ" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleJ"/>
    <xsl:param name="Form1120ScheduleK" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleK"/>
    <xsl:param name="Form1120ScheduleL" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleL"/>
    <xsl:param name="Form1120ScheduleM1" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleM1"/>
    <xsl:param name="Form1120ScheduleM2" select="$RtnDoc/IRS1120EliminationsOrAdj/IRS1120ScheduleM2"/>
    <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      <head>
        ...
        <meta name="Description" content="IRS Form 1120Eliminations Or Adjustments"/>
        ...
        <form name="IRS1120">
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:1px;">
            <div class="styFNBox" style="width:33mm;height:19mm;border-right-width:2px;">
              ...
              </span><!-- can not find the open tag but if delete then code not working.../-->
            </div>
            <div class="styFTBox" style="width:123mm;height:19mm;">
				...
				<div class="styFST" style="height:5mm;font-size:7pt;text-align:center;padding-top:1mm;">
			...
			<div class="styTYBox" style="width:31mm;height:19mm;border-left-width:2px;">
				...
				<div class="styTY" style="height:11mm;">20<span class="styTYColor">16</span>
				</div>
			</div>
		</div>
        <!--Start Box A -->
...
Per version Tree TY2008 directory, IBM modified the Style Sheet code from just a Consolidated return checkbox to one checkbox(Consolidated) and two pen and ink for (Parent and Subsidiary) and in the additional data section to show an “X” for checkbox type for pen and ink data per the business request.  This to allow RRD/HD to have a choice to display Consolidated, Parent and Subsidiary information separately on screen and to allow form 1120L and 1120PC filing to be a part of 1120 form family instead of a standalone forms. 
				-->
							<div class="styComType" style="width:33mm;border-bottom:0px;border-right-width:0;">
								...
								<div class="styGenericDiv" style="width:29mm;">
									...
									<div style="float:right;height:3mm;">
										<input type="checkbox"  alt="IRS1120IsConsolidatedReturn" class="styCkbox">
							...
							<div class="styComType" style="width:33mm;padding-top:1mm;border-bottom:0px;border-right-width:0;">
								...
								<div class="styGenericDiv" style="width:29mm;">
									...
									<div style="height:3mm;float:right;">
										...
										<input type="checkbox"  alt="IRS1120LifeNonlifeConsolidatedReturn" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$Form1120Data/LifeNonlifeConsolidatedRetInd"/>
												<xsl:with-param name="BackupName">IRS1120LifeNonlifeConsolidatedReturn</xsl:with-param>
											</xsl:call-template>
							...
							<div class="styComType" style="width:33mm;border-bottom:0px;border-right:0;">
								...
								<div class="styGenericDiv" style="width:28.5mm;">
									...
									<div style="float:right;height:3mm;">
										<input type="checkbox" alt="IRS1120PersonalHoldingCompany" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$Form1120Data/PersonalHoldingCompanyInd"/>
												<xsl:with-param name="BackupName">IRS1120PersonalHoldingCompany</xsl:with-param>
											</xsl:call-template>
							...
							<div class="styComType" style="width:33mm;border-bottom:0px;border-right:0;">
								...
								<div class="styGenericDiv" style="width:29mm;">
									...
									<div style="float:right;height:3mm;">
										<span class="styDotLn">.</span>
										<input type="checkbox" alt="IRS1120PersonalServiceCorporation" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$Form1120Data/PersonalServiceCorporationInd"/>
												<xsl:with-param name="BackupName">IRS1120PersonalServiceCorporation</xsl:with-param>
											</xsl:call-template>
							...
							<div class="styComType" style="width:33mm;border-bottom:0px;border-right:0;">
								...
								<div class="styGenericDiv" style="width:29mm;">
									...
									<div style="float:right;height:3mm;">
										<span class="styDotLn">..</span>
										<input type="checkbox" alt="IRS1120ScheduleM3Attached" class="styCkbox">
											<xsl:call-template name="PopulateCheckbox">
												<xsl:with-param name="TargetNode" select="$Form1120Data/ScheduleM3AttachedInd"/>
												<xsl:with-param name="BackupName">IRS1120ScheduleM3Attached</xsl:with-param>
											</xsl:call-template>
				  ...
				  City or town, state or province, country, and ZIP or foreign postal code<br/>
							...
							<div style="width:146mm; height:auto;vertical-align:top;">
								...
								<input type="checkbox" alt="IRS1120FinalReturn" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
					...
					Final return
								...
								<input type="checkbox" alt="IRS1120NameChange" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
					...
					Name change
								...
								<input type="checkbox" alt="IRS1120AddressChange" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<input type="checkbox" alt="IRS1120AmendedReturn" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<input type="checkbox" alt="IRS1120SupersededReturn" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
        ...
        <div class="styBB" style="width:187mm;float:none;clear:none;">
          <div class="styIRS1120VTImageBox" style="width:6mm;height:59mm;padding-top:23mm;text-align:center;">
      ...
      <!-- line 1a -->
		  ...
		  <div class="styGenericDiv" style="width:181mm;">
			...
			<div style="float:right;clear:none">
			  ...
			  <div class="styLNRightNumBox" style="height:5mm;background-color:lightgrey;border-right-width:0px;border-bottom-width:0px;"/>
			  <div class="styLNAmountBox" style="height:5mm;background-color:lightgrey;border-left-width:0px;border-bottom-width:0px;"/>	  
			</div>
		  </div>				
		  <!-- line 1b -->
		  <div class="styGenericDiv" style="width:181mm;">
      ...
      <!-- line 27 -->
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="float:left;clear:none;">
			    ...
			    <div class="styLNDesc" style="width:132mm;padding-top:1mm;padding-bottom:0mm;font-size:6.5pt;">
			  ...
			  <div style="float:right;clear:none;">
			    <div class="styLNRightNumBox" style="height:5mm;">28</div>
			    <div class="styLNAmountBox" style="height:5mm;">
				  <xsl:call-template name="PopulateAmount">
				    <xsl:with-param name="TargetNode" select="$Form1120Data/TaxableIncomeBfrNOLSpclDedAmt"/>
				  </xsl:call-template>
			...
			<div class="styGenericDiv" style="width:181mm;">
			  ...
			  <div style="float:right;clear:none;">
			    <div class="styLNRightNumBoxNBB" style="height:5.5mm;padding-top:1mm;">29c</div>
			    <div class="styLNAmountBoxNBB" style="height:5.5mm;padding-top:1mm;">
				  <xsl:call-template name="PopulateAmount">
			...
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="float:left;clear:none;">
			    ...
			    <div class="styLNDesc" style="width:132mm;">
				  ...
				  <input type="checkbox" alt="IRS1120Form2220Attached" class="styCkbox">
				    <xsl:call-template name="PopulateCheckbox">
					  <xsl:with-param name="TargetNode" select="$Form1120Data/Form2220AttachedInd"/>
					  <xsl:with-param name="BackupName">IRS1120Form2220Attached</xsl:with-param>
				    </xsl:call-template>
      ...
      <!--line 36 -->
			<div class="styGenericDiv" style="width:181mm;">
			  <div style="float:left;clear:none;">
			    ...
			    <div class="styLNDesc" style="width:88mm;">
						<span style="font-size:6pt;">Enter amount from line 35 you want:</span>
          ...
          <!-- Implementing the signature section as a table -->
					<table border="0" cellspacing="0" cellpadding="0" style="width:187mm;height:25mm;font-size:6pt;border-bottom:1px solid black;">
						<tr>
						...
						<tr>
							...
							<td rowspan="2" style="width:40mm;padding-bottom:1mm;">
								...
								<div style="border:3px solid black;float:right;height:13mm;" class="styGenericDiv">
									...
									<span style="padding-left:1mm;width37mm;vertical-align:top;">See instructions.
										<input class="styCkbox" type="checkbox" alt="ReturnHeaderMayIRSDiscussReturnWithPrep" name="Checkbox" id="dummyidyes" style="width:2.5mm;" >
											<xsl:call-template name="PopulateReturnHeaderOfficer">
										...
										<input class="styCkbox" type="checkbox" alt="ReturnHeaderMayIRSDiscussReturnWithPrep" name="Checkbox" id="dummyidno" style="width:2.5mm;">
											<xsl:call-template name="PopulateReturnHeaderOfficer">
          ...
          <!-- paid preparer -->
					<div class="styBB" style="width:187mm;font-size:6pt;">
						<div style="width:23mm;padding-top:4mm;padding-bottom:4mm;float:left;clear:none;">
							<span class="styMainTitle" style="font-size:11pt;height:16.5mm;padding-top:2mm;">
									Paid
									Preparer
									Use Only
									</span>
                  ...
                  <br/>
							...
							<div style="width:164mm;float:left;clear:none;border-bottom:1px solid black;border-left:1px solid black;border-top:1px solid black;">
								<div class="styLNDesc" style="height:7mm;width:125.7mm;border-right:1px solid black;padding-left:1mm;">
								...
								<div class="styLNDesc" style="height:7mm;width:32mm;padding-left:1mm;">Firm's EIN
									<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
									<span style="width:4px;"/>
          ...
          <p>
						<div class="pageEnd" style="width:187mm;padding-top:0mm;">
							...
							<div style="float:right;">
								...
								Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2016)
							</div>
						</div>
					</p>
          ...
          <div class="styBB" style="width:187mm;padding-top:.5mm;">
            <div style="float:left;">Form 1120 (2016)<span style="width:148mm;"/>
          </div>
        ...
        <!-- BEGIN Schedule C Table -->
						...
						<thead>
							<tr scope="col">
								<th scope="col" class="styBB" colspan="2" style="width:93mm;height:8mm;">
									<div class="styPartName" style="width:20mm;padding-top:0;">Schedule C</div>
									<div class="styPartDesc" style="width:72mm;float:left;clear:none;">Dividends and Special Deductions
                ...
                <span style="float:left;">certain FSCs </span>
							...
							<tr>
								...
								<td class="styLNAmountBox" style="width:40mm;height:7mm;padding-top:3.5mm;border-bottom-width:1.5px;">
									<xsl:call-template name="PopulateAmount">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleC/WhollyOwnFrgnSbsdryDivRcvdAmt"/>
									</xsl:call-template>
								</td>
								<td class="styIRS1120LNPercentBox" style="height:7mm;padding-top:3.5mm;border-bottom-width:1.5px;">100</td>
								<td class="styLNAmountBox" style="width:40mm;height:7mm;padding-top:3.5mm;border-bottom-width:1.5px;">
									<xsl:call-template name="PopulateAmount">
        ...
        <!-- Schedule J, line 1 -->
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:136mm;height:8.5mm;">
								Check if the corporation is a member of a controlled group (attach Schedule O (Form 1120)). See 
								<span style="float:left;">
									instructions.
									<xsl:call-template name="SetFormLinkInline">
								...
								<div style="float:right;clear:none;text-align:right;">
									...
									<span style="float:right;">
										...
										<span style="width:4mm;">
											<input type="checkbox" alt="IRS1120ScheduleJMemberOfControlledGroup" class="styCkbox" style="">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/MemberOfControlledGroupInd"/>
					...
					<div style="width:187mm;">
						<div style="float:left;clear:none;">
							<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-top:1.3mm;">2</div>
							<div class="styLNDesc" style="width:136mm;height:4.5mm;padding-top:.5mm;">
								<span style="float:left;padding-top:0.3mm;">
                  ...
                  <!-- Form to Form Link -->
								...
								<div style="float:right;clear:none;text-align:right;">
									<!--Dotted Line-->
									<div class="styDotLn" style="padding-left:.5mm;float:left;">..</div>
									<span style="width:4px;"/>
									<span style="float:right;">
										<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
										<span style="width:4px;"/>
										<span style="width:4mm;">
											<input type="checkbox" alt="IRS1120ScheduleJQualifiedPersonalServiceCorp" class="styCkbox">
        ...
        <div style="width:187mm;">
          <div style="float:left;clear:none;">
            ...
            <div class="styLNDesc">
              <span style="float:left;"><span class="styBoldText">Total credits.</span> Add lines 5a through 5e </span>
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">.....................</div>
            </div>
          </div>
        ...
        <!--  Schedule J, Line 9a  -->
		    ...
		    <div style="width:187mm;">
			  <div style="float:left;clear:none;">
				...
				<div class="styLNDesc" style="width:99mm;">
				  <span style="padding-top:0.3mm;">Interest due under the look&#8208;back method&#8208;completed long&#8208;term contracts </span>
				  <span style="float:left;">(attach Form 8697)      
                    <span style="width:2px;"/>
				    <!-- Form to Form Link -->
				    <xsl:call-template name="SetFormLinkInline">
			...
			<div style="width:187mm;clear:both;">
			  <div style="float:left;clear:none;">
				<div class="styLNLeftNumBox">13</div>
				<div class="styLNDesc">
				  <span style="float:left;">2016 estimated tax payments
			        <span style="width:2px;"/> 
				    <!-- Form to Form Link -->
				    <xsl:call-template name="SetFormLinkInline">
			...
			<div style="width:187mm;clear:both;">
			  <div style="float:left;clear:none;">
				<div class="styLNLeftNumBox">14</div>
				<div class="styLNDesc">
				  <span style="float:left;">2016 refund applied for on Form 4466
			        <span style="width:2px;"/> 
				  </span>
				  <!--Dotted Line-->
				  <span class="styDotLn" style="float:right;padding-right:1mm;">....................</span>
...
-->
          ...
          <!-- Schedule K, line 1 -->
          <div style="width:187mm;">
            <div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-top:2mm;">1</div>
            <div class="styLNDesc" style="width:167mm;height:4.5mm;">Check accounting method:
							<span style="width:5mm;"/>
              <span class="styBoldText">a</span>
              <span style="width:3px;"/>
              <input type="checkbox" alt="IRS1120ScheduleKMethodOfAccountingCash" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
              ...
              <span class="styBoldText">b</span>
              <span style="width:3px;"/>
              <input type="checkbox" alt="IRS1120ScheduleKMethodOfAccountingAccrual" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
              ...
              <label>
                ...
                <span style="width:89mm;">
                  ...
                  <span class="styBoldText">c</span>
                  <span style="width:3px;"/>
                  <input type="checkbox" alt="IRS1120ScheduleKMethodOfAccountingOther"  class="styCkbox">
                    <xsl:call-template name="PopulateCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/MethodOfAccountingOtherInd"/>
                      <xsl:with-param name="BackupName">IRS1120ScheduleKMethodOfAccountingOther</xsl:with-param>
                    </xsl:call-template>
                  ...
                  Other (specify)
                  <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
                  <span style="width:51.5mm;border-bottom:1px solid black;">
                    <xsl:call-template name="PopulateText">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm;height:4.5mm;padding-bottom:0px;padding-top:0px;">
              <span style="float:left;padding-top:0.3mm;">Is the corporation a subsidiary in an affiliated group or a parent&#8208;subsidiary controlled group?
                <xsl:call-template name="LinkToLeftoverDataTableInline">
            ...
            <div class="styGenericDiv" style="width:187mm;">
              ...
              <div class="styLNDesc" style="width:167mm;height:4.5mm;">
                ...
                <span style="width:166mm;border-bottom:1px solid black;">
                  <xsl:call-template name="PopulateText">
                  ...
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      <!--NOTE: FOREIGNUS CHOICE IS NOT VALID FOR 1120E&A-->
                      <xsl:call-template name="PopulateText">
          ...
          <!-- Schedule K, Line 4 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-top:1.5mm;">4</div>
						<div class="styLNDesc" style="width:167mm;height:4.5mm;padding-top:1.5mm;">At the end of the tax year: </div>
						<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
						<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
					</div>
					<!-- Schedule K, Line 4a -->
			...
			<!-- BEGIN Schedule K Title -->
			  <div class="styBB" style="width:187mm;border-top-width:1px;">
				<div class="styPartName" style="height:4mm;width:23mm;">Schedule K</div>
						<div style="height:4mm;width:164mm;" class="styPartDesc">Other Information
						<span style="font-style:italic;font-weight:normal;">(continued from page 3)</span>
						</div>
			  </div>
          ...
          <!-- Schedule K, Line 5a row 1 and 2-->
					<div style="width:187mm;height:6.5mm;">
						<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-left:4mm;">a</div>
						<div class="styLNDesc" style="width:167mm;height:8.5mm; ">
          ...
          <!-- BEGIN Schedule K, Line 5a Tittle -->
          ...
          <!-- Schedule K, Line 5b Yes and No --> <!--Update per WR51699 for R7_DD4 PDF draft dated 8/9/2011
          -->
            ...
            <table class="styTable" cellspacing="0" style="font-size:7pt;">
              <thead class="styTableThead">
                <tr>
                  ...
                  <th class="styTableCellHeader" scope="col" rowspan="2" style="width:35mm;font-weight:normal;">
                    <span style="font-weight:bold;">(ii)</span> Employer<br/> Identification Number<br/> (if any)</th>
                  <th class="styTableCellHeader" scope="col" rowspan="2" style="width:20mm;font-weight:normal;">
                    <span style="font-weight:bold;">(iii)</span> Country of<br/> Organization</th>
                  <th class="styTableCellHeader" scope="col" rowspan="2" style="width:36mm;font-weight:normal;border-right:0;">
                    <span style="font-weight:bold;">(iv)</span>Maximum Percentage Owned in Profit, Loss or Capital</th>
                </tr>
              </thead>
              <tfoot/>
              <tbody>
          ...
          <!-- BEGIN Schedule K, Line 7 row 3-->
          <div style="width:187mm;">
            <div class="styLNLeftNumBoxSD" style="height:2.5mm;font-weight:bold"/>
          ...
          <!-- BEGIN Schedule K, Line 7(i) and 7(ii)-->
          <div style="width:187mm;">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm; ">
              ...
              <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:3px;"/>
              <span style="width:42mm;border-bottom:1px solid black;text-align:right;">
                <xsl:call-template name="PopulateText">
                  <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/TotalForm5472FiledCnt"/>
                </xsl:call-template>
              </span>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm;">
              ...
              <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:3mm;"/>
              <input type="checkbox" alt="IRS1120ScheduleKOfferedDebtInstruments" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm; ">
              Enter the number of shareholders at the end of the tax year (if 100 or fewer)
							<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:3px;"/>
              <span style="border-bottom:1px solid black;width:65.5mm;text-align:right;">
                <xsl:call-template name="PopulateText">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm; ">
              ...
              <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:3mm;"/>
              <input type="checkbox" alt="IRS1120ScheduleKNOLForegoCarryback" class="styCkbox">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/NOLForegoCarrybackInd"/>
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:167mm;">
              ...
              must be attached or the election won't be valid.
            </div>
            <div class="styGenericDiv">
              <div class="styShadingCell" style="width:6mm;height:8.5mm;"/>
              <div class="styShadingCellRB" style="width:6mm;height:8.5mm;border-right-width:0px;"/>
          ...
          <div style="width:187mm;">
            <div class="styLNLeftNumBox">12</div>
            <div class="styLNDesc" style="width:167mm;font-size:7pt; ">
              Enter the available NOL carryover from prior tax years (don't reduce it by any deduction on line 29a.)
							<img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
			        <span style="width:2px;"/>
              <span style="width:1px;">$</span>
              <span style="border-bottom:1px solid black;width:33.5mm;text-align:right;">
                <xsl:call-template name="PopulateAmount">
          ...
          <!-- Schedule K, Line 13-->
			        ...
			        <span style="float:left;">tax year less than $250,000? </span>
						...
						<div class="styGenericDiv">
							<div class="styIRS1120LNYesNoBox" style="padding-top:3mm;height:7mm;border-bottom-width:1px;">
								<span style="font-weight:normal;">
									<xsl:call-template name="PopulateYesBoxText">
							...
							<div class="styIRS1120LNYesNoBoxRB" style="padding-top:3mm;height:7mm;border-right-width:0px;border-bottom-width:1px;">
								<span style="font-weight:normal;">
									<xsl:call-template name="PopulateNoBoxText">
										<xsl:with-param name="TargetNode" select="$Form1120ScheduleK/TotalRcptsAssetsLessThanLmtInd"/>
									</xsl:call-template>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:4.5mm;"/>
						<div class="styLNDesc" style="width:167mm;height:4.5mm; ">
                      If "Yes," the corporation isn't required to complete Schedules L, M&#8208;1, and M&#8208;2. Instead, enter the total amount of cash
							</div>
						<div class="styShadingCell" style="width:6mm;height:4.5mm;"/>
						<div class="styShadingCellRB" style="width:6mm;height:4.5mm;border-right-width:0px;"/>
						<div class="styLNDesc" style="width:175mm;height:4.5mm;padding-left:8mm;"> distributions and the book value of property distributions (other than cash) made during the tax year.
                      <img src="{$ImagePath}/1120_Bullet_Sm.gif" alt="SmallBullet"/>
              <span style="width:2px;"/>        
							<span style="width:1px;">$</span>
          ...
          <!-- Schedule K, Line 15a--><!--WR66367-->
		  <div style="width:187mm;">
			<div class="styLNLeftNumBox">15a</div>
			<div class="styLNDesc" style="width:167mm;">
			  <span style="float:left;">Did the corporation make any payments in 2016 that would require it to file Form(s) 1099? </span>
			  <!--Dotted Line-->
			  <div class="styDotLn" style="float:right;padding-right:1mm;">............</div>
			</div>
			<div class="styGenericDiv">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNDesc" style="width:51mm;height:7mm;font-size:7pt;">
          ...
          <!-- Schedule L, line 22a-->
          <div style="width:187mm;">
            <div class="styLNLeftNumBox" style="height:4.5mm;padding-top:1.3mm;">22</div>
            <div class="styLNDesc" style="width:51mm;height:4.5mm;">
            ...
            <div class="styLNAmountBox" style="height:5.5mm;font-family:arial;font-size:8pt;">
              <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm;">
            ...
            <div class="styLNAmountBox" style="height:5.5mm;font-family:arial;font-size:8pt;border-bottom-width:1px;">
              <xsl:call-template name="PopulateAmount">
          ...
          <div style="width:187mm;">
            ...
            <div class="styShadingCell" style="height:10mm;"/>
            <div class="styLNFormLinkBox" style="height:10mm;padding-top:1.5mm;padding-top:3mm;">
              <!-- Form to Form Link -->
              <span style="width:2px;"/>
              <xsl:call-template name="SetFormLinkInline">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styGenericDiv" style="width:51mm;height:4.5mm;">
              <span style="font-size:6.5pt;">Total liabilities and shareholders' equity</span>
            </div>
            <div class="styShadingCell" style="height:4.5mm;"/>
					...
					<div class="styBB" style="width:187mm;clear:both;">
						...
						<table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:51mm;height:6mm;" colspan="2">
										<div class="styGenericDiv" style="width:26mm;padding-top:0.5mm;">Travel and entertainment 
                      <span style="font-size:6pt;"/>$	 
						  <xsl:call-template name="SetFormLinkInline">
								...
								<tr>
									<!-- Schedule M-1, Line 6-->
									<td class="styLNLeftNumBoxSD" style="height:4.5mm;padding-top:0.5mm">6</td>
									<td class="styGenericDiv" style="width:51mm;height:4.5mm;padding-top:0.5mm" colspan="2">
							...
							<tbody>
								...
								<tr class="styGenericDiv">
									...
									<td class="styGenericDiv" style="width:54mm;height:3.5mm;" colspan="2">
										Tax&#8208;exempt interest 
					  <span style="width:4px;"/>$<span style="width:1px;"/>
										<xsl:call-template name="SetFormLinkInline">
											<xsl:with-param name="TargetNode" select="$Form1120ScheduleM1/TotIncmRecordedNotIncludedAmt"/>
										</xsl:call-template>
										<span style="border-bottom:1px solid black;text-align:right;float:right;width:20mm;">
											<xsl:call-template name="PopulateAmount">
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:54mm;height:4.5mm;" colspan="2">
										<div class="styGenericDiv" style="width:21mm;padding-top:0.7mm;">Depreciation<span style="width:1mm;"/>$ </div>
								...
								<tr>
									...
									<td class="styGenericDiv" style="width:54mm;height:4.5mm;" colspan="2">
										<div class="styGenericDiv" style="width:23.5mm;padding-top:0.7mm;">
										...
										<div class="styIRS1120BBText" style="width:29.5mm;height:6.5mm;float:left;text-align:right;padding-top:3mm;">
											<xsl:call-template name="PopulateAmount">
								...
								<tr class="styGenericDiv">
									...
									<td class="styLNAmountBox" style="height:5.5mm;padding-top:1.5mm;">
										<xsl:call-template name="PopulateAmount">
          ...
          <!-- BEGIN Schedule M-2 Line Items -->
						...
						<table class="styTable" style="width:93mm;float:left;clear:none;font-size:7pt;" cellspacing="0">
							...
							<tr class="styGenericDiv" style="height:4.5mm;">
								...
								<td class="styGenericDiv" style="width:51mm;height:4.5mm;padding-right:2mm;" colspan="2">
									<div class="styIRS1120BBText" style="padding-top:3mm;width:50.5mm;float-right;"/>
								</td>
							...
							<tr class="styGenericDiv" style="height:4mm;">
								<td class="styLNLeftNumBoxSD" style="height:4mm;"/>
								<td class="styGenericDiv" style="width:51mm;height:4.5mm;padding-right:2mm;" colspan="2">
									<div class="styIRS1120BBText" style="width:50.5mm;text-align:right;height:4mm;padding-right:3mm;">
									</div>
								</td>
								<td class="styLNAmountBox" style="height:4.5mm;border-right-width:1px;border-bottom-width: 1px">
									<xsl:call-template name="PopulateAmount">
                    ...
                    Cash 
							...
							<tr class="styGenericDiv">
								...
								<td class="styGenericDiv" style="width:54mm;height:4mm;padding-top:0.3mm" colspan="2">
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120</span> (2016)
        ...
        Additional Data        
          ...
          <table class="styLeftOverTbl">
            ...
            <!--REMOVE 6.2_Drop 1<xsl:call-template name="PopulateLeftoverRow">
            ...
            <!-- Difference Pen and Ink not on 1120E&A but on 1120 -->
             <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Form 1120, Top Left Margin - Short Period Reason 1120 1120F Ind</xsl:with-param>
            ...
            <!-- not display -->
						<!--11/25/2015 CJ: The customer (Wallace Kendell E) approved for the exception. The new template (LinkToLeftoverCheckboxDataTableInline) is created for a Pen and ink to display yes and no instead of “x”. -->
            <xsl:choose>
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Page 1, Line 32b - Beneficiary Of Trust Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120Data/EstimatedTaxPaymentsAmt/@beneficiaryTrustCd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Form 1120, Page 1, Line 32b - Beneficiary Of Trust Amount</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120Data/EstimatedTaxPaymentsAmt/@beneficiaryTrustAmt"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Page 1, Line 32b - Form 8816 Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120Data/EstimatedTaxPaymentsAmt/@form8816Cd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Form 1120, Page 1, Line 32b - Form 8816 Amount</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120Data/EstimatedTaxPaymentsAmt/@form8816Amt"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Page 1, Line 32b - Section 847 Deduction Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120Data/EstimatedTaxPaymentsAmt/@section847DeductionCd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Page 1, Line 32f(2) - Ozone Depleting Chemicals Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120Data/TotalFuelTaxCreditAmt/@ozoneDepletingChemicalCd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule J, Line 2 - Section 1291 Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section1291Cd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Form 1120, Schedule J Line 2 - Section 1291 Amount</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section1291Amt"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule J Line 2 - Section 197 Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section197Cd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Form 1120, Schedule J Line 2 - Section 197 Amount</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/IncomeTaxAmt/@section197Amt"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule J, Line 5b - Form 5735 Indicator</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/QlfyElecMotorVehCrAmt/@form5735Cd"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
            <xsl:call-template name="PopulateLeftoverRowAmount">
              <xsl:with-param name="Desc">Form 1120, Schedule J, Line 5b - Form 5735 Amount </xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleJ/QlfyElecMotorVehCrAmt/@form5735Amt"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
		    <xsl:call-template name="PopulateLeftoverRow">
            ...
            <xsl:call-template name="PopulateLeftoverRow">
              <xsl:with-param name="Desc">Form 1120, Schedule K Line 3 - Parent Corporation Name Control</xsl:with-param>
              <xsl:with-param name="TargetNode" select="$Form1120ScheduleK/PrntCorporationNameControlTxt"/>
              <xsl:with-param name="DescWidth" select="100"/>
            </xsl:call-template>
          </table>
